...
- [ ] **Compute a curve coefficient for each weekday.** — *Owner:* @sergeierbin
- [ ] **Build next-day hourly forecast** — combine next-day daily forecast and day-curve. — *Owner:* @martinoland1
